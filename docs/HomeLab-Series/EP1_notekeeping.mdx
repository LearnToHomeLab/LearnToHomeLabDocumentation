...
<div style={{
  ...
  <iframe 
    width="560" 
    height="315" 
    src="https://www.youtube.com/embed/1yVyse8Z2SY?si=lFUH1d1lKCqYccYi" 
    frameBorder="0" 
...
<DocImage folder="images/EP0_notekeeping" name="step_1_note.png" alt="Description of your image" />

Now you can run the installer.

<DocImage folder="images/EP0_notekeeping" name="step_2_note.png" alt="Description of your image" />

You will be brought to this menu, select *quick start*.

<DocImage folder="images/EP0_notekeeping" name="step_3_note.png" alt="Description of your image" />
...
<DocImage folder="images/EP0_notekeeping" name="step 4_1.1.1.png" alt="Description of your image" />

Step 2: Go to the *appearance tab* and then at the very top change *adapt to system* to dark mode.

<DocImage folder="images/EP0_notekeeping" name="step 5_1.1.1_1.1.2.png" alt="Description of your image" />

Step 3: We will then go under *Files and Links*, *Default location for new attachments* and select *in subfolder under current folder* which will put our screenshots/images in their own folder to keep our note taking environment clean.

<DocImage folder="images/EP0_notekeeping" name="step 6_1.1.1_1.1.2_1.1.3.png" alt="Description of your image" />
