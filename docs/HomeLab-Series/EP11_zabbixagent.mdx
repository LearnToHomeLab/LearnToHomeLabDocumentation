...
If you want to know how to setup the Zabbix server please find our article/video on that [here](/HomeLab-Series/EP10_zabbixserver.mdx).
...
<div style={{
  ...
  <iframe 
    width="560" 
    height="315" 
    src="https://www.youtube.com/embed/JYr1iXsgra8?si=epf_2LG90cJUi1Qd" 
    frameBorder="0" 
...
<DocImage folder="images/EP11_zabbixagent" name="Still 2025-01-08 081514_1.3.1.png" alt="Description of your image" />
...
<DocImage folder="images/EP11_zabbixagent" name="Still 2025-01-08 081514_1.3.2.png" alt="Description of your image" />

## Configure the Zabbix Agent Config file

Now we need to change two entries in our config file. We need to point our AGENT AT the IP address of our **Zabbix SERVER!**
...
<DocImage folder="images/EP11_zabbixagent" name="Still 2025-01-08 081514_1.3.3.png" alt="Description of your image" />

AND 

<DocImage folder="images/EP11_zabbixagent" name="Still 2025-01-08 081514_1.3.4.png" alt="Description of your image" />
...
<DocImage folder="images/EP11_zabbixagent" name="Still 2025-01-08 081514_1.3.5.png" alt="Description of your image" />
...
<DocImage folder="images/EP11_zabbixagent" name="Still 2025-01-08 081514_1.4.1.png" alt="Description of your image" />
...
<DocImage folder="images/EP11_zabbixagent" name="Still 2025-01-08 081514_1.4.2.png" alt="Description of your image" />

Picture showing data it is currently pulling:

<DocImage folder="images/EP11_zabbixagent" name="Still 2025-01-08 081514_1.4.3.png" alt="Description of your image" />

## Closing thoughts

That is it! Pretty simple right? Now in another episode we will cover how to add these hosts to data panels on your dashboard but Zabbix is so extensive I would recommend you Google around yourself and find what you want and add them that way.
