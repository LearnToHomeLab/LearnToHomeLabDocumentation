...
Learn from me: my wife and I went on an honeymoon cruise to The Bahamas and virtually have NO pictures of our trip because our phones got water damaged! Backing up your pictures at the end of each day to your NextCloud server could save you much heartache! We learned, though, that our Europe trip of 2024 was full of me backing up our content daily! *This Episode won't cover how to back up your content outside of your network, but our TailScale episode will!*
...
<div style={{
  ...
  <iframe 
    width="560" 
    height="315" 
    src="https://www.youtube.com/embed/SbGSgMMt6gg?si=lPlB3rZp0Svq9eyk" 
    frameBorder="0" 
...
<DocImage folder="images/EP8_nextcloud" name="Still 2024-12-30 112738_1.3.1.png" alt="Description of your image" />
...
I am not going to show every tab, but you can see from the image below there is general, templates, etc. We are concerned about the templates tab where you will select nextcloud, the *Disks* tab SET THIS AS HIGH AS YOU CAN. This determines how many pictures you can save., and then under the network tab we need to set a static IP address for our machine. We need to ensure in OPNsense or your router that the IP you are assigning has not already been issued to another machine.

<DocImage folder="images/EP8_nextcloud" name="Still 2024-12-30 112738_1.4.1.png" alt="Description of your image" />
...
<DocImage folder="images/EP8_nextcloud" name="Still 2024-12-30 112738_1.7.1.png" alt="Description of your image" />
...
<DocImage folder="images/EP8_nextcloud" name="Still 2024-12-30 112738_1.8.1.png" alt="Description of your image" />
...
<DocImage folder="images/EP8_nextcloud" name="Still 2024-12-30 112738_1.8.2.png" alt="Description of your image" />
...
<DocImage folder="images/EP8_nextcloud" name="Still 2024-12-30 112738_1.9.1.png" alt="Description of your image" />

Login screen image:

<DocImage folder="images/EP8_nextcloud" name="Still 2024-12-30 112738_1.9.2.png" alt="Description of your image" />
...
<DocImage folder="images/EP8_nextcloud" name="Still 2024-12-30 112738_1.9.3.png" alt="Description of your image" />

Nextcloud Admin (YOU WILL LOGIN WITH THIS ONE!)

<DocImage folder="images/EP8_nextcloud" name="Still 2024-12-30 112738_1.9.4.png" alt="Description of your image" />

You can skip this one, we are not going to access Nextcloud with a URL.

<DocImage folder="images/EP8_nextcloud" name="Still 2024-12-30 112738_1.9.5.png" alt="Description of your image" />

We are not going to use Turnkey backup so you can click your tab key twice and then enter for skip.

<DocImage folder="images/EP8_nextcloud" name="Still 2024-12-30 112738_1.9.6.png" alt="Description of your image" />

You can enter an email here for notifications if you'd like.

<DocImage folder="images/EP8_nextcloud" name="Still 2024-12-30 112738_1.9.7.png" alt="Description of your image" />

Always ensure you have the latest security updates so click install.

<DocImage folder="images/EP8_nextcloud" name="Still 2024-12-30 112738_1.9.8.png" alt="Description of your image" />
...
<DocImage folder="images/EP8_nextcloud" name="Still 2024-12-30 112738_1.10.1.png" alt="Description of your image" />
...
<DocImage folder="images/EP8_nextcloud" name="Still 2024-12-30 112738_1.11.1.png" alt="Description of your image" />

If click documentation we are taken to this page that gives us some insight on how to fix this.

<DocImage folder="images/EP8_nextcloud" name="Still 2024-12-30 112738_1.11.2.png" alt="Description of your image" />

We need to go into the following settings directory to make the correct changes.
```
nano /var/www/nextcloud/config/config.php
```
<DocImage folder="images/EP8_nextcloud" name="Still 2024-12-30 112738_1.11.3.png" alt="Description of your image" />

You will be presented with the following file and we are going to edit the following 'trusted_domains' section.

<DocImage folder="images/EP8_nextcloud" name="Still 2024-12-30 112738_1.11.4.png" alt="Description of your image" />

We want to make that section in ours look like this:
```
'trusted_domains' =>
array (
0 => 'localhost',
...
<DocImage folder="images/EP8_nextcloud" name="Still 2024-12-30 112738_1.11.5.png" alt="Description of your image" />

Now we can go back to the site and login:

<DocImage folder="images/EP8_nextcloud" name="Still 2024-12-30 112738_1.11.6.png" alt="Description of your image" />

Before we continue, we need to set the static IP address of our NextCloud container in OPnsense.

First let's grab the Mac address of our container under our container network settings location. Select the network card and click edit, then copy the MAC.

<DocImage folder="images/EP8_nextcloud" name="Still 2024-12-30 112738_1.16.1.png" alt="Description of your image" />

Now go over to OPNsense and we can create a static listing under Services / ISC DHCPv4 / [LAN] and selecting the + button.

<DocImage folder="images/EP8_nextcloud" name="Still 2024-12-30 112738_1.12.1.png" alt="Description of your image" />

Now we can take that MAC address and our IP address and add it into our static assignment. Then click save.

<DocImage folder="images/EP8_nextcloud" name="Still 2024-12-30 112738_1.16.2.png" alt="Description of your image" />
...
<DocImage folder="images/EP8_nextcloud" name="Still 2024-12-30 112738_1.16.3.png" alt="Description of your image" />

## Login on your phone

Download the NextCloud app and you can connect to your server using that IP address just like you did in your browser.

<DocImage folder="images/EP8_nextcloud" name="Still 2024-12-30 112738_1.17.1.png" alt="Description of your image" />

Select yes on the certificate, we trust it because it's our certificate!

<DocImage folder="images/EP8_nextcloud" name="Still 2024-12-30 112738_1.17.2.png" alt="Description of your image" />

Then you can login.

<DocImage folder="images/EP8_nextcloud" name="Still 2024-12-30 112738_1.17.3.png" alt="Description of your image" />

Now you're connected, go back over to your app to use NextCloud.

<DocImage folder="images/EP8_nextcloud" name="Still 2024-12-30 112738_1.18.1.png" alt="Description of your image" />

Then we can use the + button just like the site and upload pictures or create folders.

<DocImage folder="images/EP8_nextcloud" name="Still 2024-12-30 112738_1.20.2.png" alt="Description of your image" />
