...
<DocImage folder="images/EP16_wazuhagent" name="Still 2025-01-23 142106_1.2.1.png" alt="Description of your image" />
...
<div style={{
  ...
  <iframe 
    width="560" 
    height="315" 
    src="https://www.youtube.com/embed/xxStl870B6k?si=HOAi9fjeHIw9lQvD" 
    frameBorder="0" 
...
<DocImage folder="images/EP16_wazuhagent" name="Still 2025-01-23 142106_1.4.1.png" alt="Description of your image" />
...
<DocImage folder="images/EP16_wazuhagent" name="Still 2025-01-23 142106_1.4.2.png" alt="Description of your image" />

Next, SSH into your machine and paste that script. 

<DocImage folder="images/EP16_wazuhagent" name="Still 2025-01-23 142106_1.4.3.png" alt="Description of your image" />

(Script pasted from the dashboard shown earlier)

<DocImage folder="images/EP16_wazuhagent" name="Still 2025-01-23 142106_1.4.4.png" alt="Description of your image" />
...
<DocImage folder="images/EP16_wazuhagent" name="Still 2025-01-23 142106_1.4.5.png" alt="Description of your image" />

(Pasting the commands from step 5 onto the machine we installed the agent on)

<DocImage folder="images/EP16_wazuhagent" name="Still 2025-01-23 142106_1.4.6.png" alt="Description of your image" />
...
<DocImage folder="images/EP16_wazuhagent" name="Still 2025-01-23 142106_1.5.1.png" alt="Description of your image" />
...
<DocImage folder="images/EP16_wazuhagent" name="Still 2025-01-23 142106_1.5.2.png" alt="Description of your image" />
...
<DocImage folder="images/EP16_wazuhagent" name="Still 2025-01-23 142106_1.5.3.png" alt="Description of your image" />

## Searching all indexed items

Opening the menu on the top right, going under the explore section and selecting discover allows you to search your whole network and all indexes that the agents create. An index is essentially every event on every live agent that occurs on the device as long as its being recorded by the agent. 

<DocImage folder="images/EP16_wazuhagent" name="Still 2025-01-23 142106_1.5.4.png" alt="Description of your image" />

## Testing that our agent works and is indexing

We are going to test that the agent is indexing by doing one of the concept guides (failed login attempts over SSH). I logged into my Ubuntu VM and failed to login to the machine with the Wazuh agent installed on it numerous times (Wazuh will create an index if three failed attempts happen within an hour).

<DocImage folder="images/EP16_wazuhagent" name="Still 2025-01-23 142106_1.6.1.png" alt="Description of your image" />
...
<DocImage folder="images/EP16_wazuhagent" name="Still 2025-01-23 142106_1.7.1.png" alt="Description of your image" />
...
<DocImage folder="images/EP16_wazuhagent" name="Still 2025-01-23 142106_1.7.2.png" alt="Description of your image" />

## Checking events by the host

We can also check for events on a single host by going back to the main dashboard / selecting that agent / clicking the agent we want / and being presented with the following screen again.

Then you can select the sections based on what incidents have occurred on your device. In our case we can now see there is a credential access option that wasn't there before.

<DocImage folder="images/EP16_wazuhagent" name="Still 2025-01-23 142106_1.7.3.png" alt="Description of your image" />

You can read about the incident here just like the discovery page, the advantage here is its only showing events for a specific type and a specific host where the discovery page shows everything (this can be useful if you are unsure what you are looking for or know an event ID number. Possibly learning as well.)

<DocImage folder="images/EP16_wazuhagent" name="Still 2025-01-23 142106_1.7.4.png" alt="Description of your image" />
...
<DocImage folder="images/EP16_wazuhagent" name="Still 2025-01-23 142106_1.7.5.png" alt="Description of your image" />

(The screen shown is after you selected save and named your custom query.)

<DocImage folder="images/EP16_wazuhagent" name="Still 2025-01-23 142106_1.7.6.png" alt="Description of your image" />

Now go over to Dashboards in the explore menu.

<DocImage folder="images/EP16_wazuhagent" name="Still 2025-01-23 142106_1.7.7.png" alt="Description of your image" />

Here you can create a new dashboard or add your query to a dashboard if you have already created one.

<DocImage folder="images/EP16_wazuhagent" name="Still 2025-01-23 142106_1.7.8.png" alt="Description of your image" />

Adding your custom query is as easy as selecting the add button found on the top right.

<DocImage folder="images/EP16_wazuhagent" name="Still 2025-01-23 142106_1.7.9.png" alt="Description of your image" />

(Selecting the query you just made/saved)

<DocImage folder="images/EP16_wazuhagent" name="Still 2025-01-23 142106_1.7.10.png" alt="Description of your image" />
...
<DocImage folder="images/EP16_wazuhagent" name="Still 2025-01-23 142106_1.7.11.png" alt="Description of your image" />
...
<DocImage folder="images/EP16_wazuhagent" name="Still 2025-01-23 142106_1.7.12.png" alt="Description of your image" />

You will be presented with this screen, click inventory on the top left for further details on these critical findings.

<DocImage folder="images/EP16_wazuhagent" name="Still 2025-01-23 142106_1.8.1.png" alt="Description of your image" />
...
At this point you are going to have to do some research online of your own. The CVE numbers are a great place to start. After you know why this is bad, the next thing you need to research is how to solve the issue based on your operating system.
...
<DocImage folder="images/EP16_wazuhagent" name="Still 2025-01-23 142106_1.8.2.png" alt="Description of your image" />
